...
- Name: settings.spec.js >> Settings >> [SET_TC_024] Verify Profile Function navigation successfully.
...
Call log:
  - waiting for locator('[class*="card"]:has-text("User Management")').first().locator('text=Profile Functions').first()
