...
- Name: settings.spec.js >> Settings >> [SET_TC_026] Verify Setup card categories display successfully.
...
Call log:
  - waiting for locator('[class*="card"]:has-text("Quality, Health & Safety")').first().locator('text=Setup Card Categories').first()
