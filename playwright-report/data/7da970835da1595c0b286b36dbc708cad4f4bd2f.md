...
- Name: settings.spec.js >> Settings >> [SET_TC_028] Verify Configuration page loads successfully.
...
Call log:
  - waiting for locator('[class*="card"]:has-text("Quality, Health & Safety")').first().locator('text=Configuration').first()
