...
- Name: settings.spec.js >> Settings >> [SET_TC_014] Verify Company Details page.
...
Call log:
  - waiting for locator('[class*="card"]:has-text("Organization"), div:has-text("Organization"):has(h2,h3)').first().locator('text=Company Details').first()
