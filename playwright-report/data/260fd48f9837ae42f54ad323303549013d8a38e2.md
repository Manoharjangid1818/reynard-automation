...
- Name: settings.spec.js >> Settings >> [SET_TC_023] Verify Certificate Management navigation successfully.
...
Call log:
  - waiting for locator('[class*="card"]:has-text("User Management")').first().locator('text=Certificate Management').first()
