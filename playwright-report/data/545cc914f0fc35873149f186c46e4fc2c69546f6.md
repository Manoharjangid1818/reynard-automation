...
- Name: settings.spec.js >> Settings >> [SET_TC_015] Verify Setup License navigation successfully.
...
Call log:
  - waiting for locator('[class*="card"]:has-text("Organization"), div:has-text("Organization"):has(h2,h3)').first().locator('text=Setup Licenses').first()
