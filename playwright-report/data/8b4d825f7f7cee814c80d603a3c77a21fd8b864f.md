...
- Name: settings.spec.js >> Settings >> [SET_TC_029] Verify General QHSE module loads successfully.
...
Call log:
  - waiting for locator('[class*="card"]:has-text("Quality, Health & Safety")').first().locator('text=General QHSE Documents').first()
